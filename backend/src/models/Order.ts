...
orderSchema.pre('validate', function prepareOrder(next) {
  ...
  this.deliveryFee = 8;
  this.delivery = { method: 'home_delivery', label: 'Livraison à domicile', fee: 8 };
